...
const listItemContent = (props: SidebarListItemProps) => (
  ...
  >
    <Link href={props.href} className="flex items-center w-full relative z-10">
      ...
      {props.type === "repo" && <Book className="size-3 text-gray-700" />}
      <span className="text-sm font-medium flex-1 truncate text-gray-900">{props.name}</span>
