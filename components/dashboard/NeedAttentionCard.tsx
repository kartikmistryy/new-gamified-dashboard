      ...
      <CardContent className="space-y-4 pt-0 px-4 pb-4">
        <div>
          <p
            ...
            className="text-xs px-2 py-1 font-semibold text-gray-700 sticky top-0 bg-white z-10"
          >
            Outlier list
          </p>
          <ul
            className="max-h-56 overflow-y-auto border border-gray-200 rounded-md bg-white divide-y divide-gray-100"
