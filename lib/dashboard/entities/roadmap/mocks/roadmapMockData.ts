...
const ARCHETYPES: DeveloperArchetype[] = [
  {
    ...
    baseLevel: 0.92, // Senior specialists - very high
  ...
  {
    id: "fullstack-senior",
    baseLevel: 0.88, // Senior full-stack - high
    canUnlockAdvanced: true,
    skillMultipliers: {
      frontend: 1.4,
      backend: 1.4,
  ...
  {
    id: "backend-dev",
    baseLevel: 0.68, // Mid-level backend
  ...
  },
  {
    ...
    baseLevel: 0.42, // Juniors - still learning
    canUnlockAdvanced: false,
    skillMultipliers: {
      frontend: 1.0,
      backend: 1.1,
  ...
  {
    id: "other-specialist",
    baseLevel: 0.55, // Specialists in non-core areas
    canUnlockAdvanced: false,
    skillMultipliers: {
      mobile: 1.4,
      "product-design": 1.3,
...
const COMPANY_SKILL_STRENGTH: Record<string, number> = {
  // Strong areas (company focus) - boosted for clear differentiation
  backend: 1.45,
  ...
  cloud: 1.1,
  leadership: 0.75,
  // Zero progress areas (for demo: filtered by "Show Unlocked")
  // - Mobile & Product & Design in Skills View
  // - QA Engineer in Role View (uses testing + security only)
  testing: 0,
  security: 0,
  "product-design": 0,
  mobile: 0,
