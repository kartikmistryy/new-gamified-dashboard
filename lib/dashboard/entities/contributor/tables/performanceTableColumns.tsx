...
import { getTrendIcon, formatChangeLabel, getChangeColor } from "@/lib/dashboard/shared/utils/trendHelpers";
import type { PerformanceFilter } from "../types";
import type { ContributorPerformanceWithDelta } from "../tables/performanceTableConfig";
