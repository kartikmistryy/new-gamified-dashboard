...
import type { OutliersMemberFilter } from "../utils/outliersHelpers";
...
export const OUTLIERS_MEMBER_COLUMNS: BaseTeamsTableColumn<MemberOutliersRow, OutliersMemberFilter>[] = [
  {
    key: "rank",
    header: "Rank",
    className: "w-14",
