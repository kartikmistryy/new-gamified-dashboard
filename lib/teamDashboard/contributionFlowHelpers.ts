...
export const MEMBER_FALLBACK_COLORS = ["#3b82f6", "#22c55e", "#f59e0b", "#a855f7", "#06b6d4", "#ef4444"];

export function formatRepoLabel(label: string): string {
  return label
    .split("-")
...
export function getRepoColor(node: ContributionNode): string {
