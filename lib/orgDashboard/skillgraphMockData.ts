...
export const SKILLGRAPH_SKILL_ROWS: SkillgraphSkillRow[] = [
  {
    ...
    details: [
      ...
      { team: "UI/UX Design", usage: 88, ownership: 74, progress: 79 },
      { team: "Web Development", usage: 90, ownership: 77, progress: 82 },
    ],
  },
  {
    ...
    contributors: 44,
    details: [
      { team: "Frontend Development", usage: 92, ownership: 80, progress: 84 },
      { team: "Web Development", usage: 88, ownership: 74, progress: 79 },
      { team: "UI/UX Design", usage: 70, ownership: 58, progress: 63 },
    ],
  },
  {
    skillName: "Node.js",
    ...
    contributors: 39,
    details: [
      { team: "Web Development", usage: 87, ownership: 76, progress: 78 },
      { team: "Mobile App Development", usage: 72, ownership: 58, progress: 61 },
      { team: "AI / ML Development", usage: 68, ownership: 55, progress: 59 },
    ],
  },
  {
    ...
    details: [
      ...
      { team: "Frontend Development", usage: 70, ownership: 58, progress: 63 },
    ],
  },
  {
    skillName: "Swift",
    ...
    contributors: 26,
    details: [
      { team: "Mobile App Development", usage: 90, ownership: 79, progress: 84 },
      { team: "Frontend Development", usage: 68, ownership: 58, progress: 61 },
      { team: "Web Development", usage: 60, ownership: 50, progress: 54 },
    ],
  },
  {
    skillName: "PyTorch",
    ...
    details: [
      ...
      { team: "Frontend Development", usage: 66, ownership: 55, progress: 59 },
    ],
  },
];
