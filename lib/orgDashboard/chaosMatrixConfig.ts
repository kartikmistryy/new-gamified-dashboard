/**
 * Chaos Matrix Chart Configuration
 *
 * Extracted Plotly configuration for the Chaos Matrix visualization.
 * Separates chart configuration from component rendering logic.
 *
 * @module lib/orgDashboard/chaosMatrixConfig
 */
...
/**
 * Standard Plotly configuration for chaos matrix
 */
